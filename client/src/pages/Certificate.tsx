    ...
    <div style={{ width: '1123px', height: '794px', padding: '40px', backgroundColor: '#fff', fontFamily: 'serif', color: '#2e2e2e', boxSizing: 'border-box' }}>
      <div style={{ position: 'relative', width: '100%', height: '100%', border: '12px solid #c59a3f', padding: '40px', boxSizing: 'border-box' }}>
        ...
        <div style={{ textAlign: 'center', marginTop: '30px' }}>
          ...
          <h2 style={{ fontSize: '16px', marginTop: '8px' }}>VOSA TECH in collaboration with Government of Tamil Nadu</h2>
          <h3 style={{ marginTop: '20px', fontSize: '28px', fontWeight: 'bold', color: '#c59a3f', textTransform: 'uppercase' }}>Certificate of Appreciation</h3>
        </div>
        ...
        <div style={{ marginTop: '40px', fontSize: '18px', lineHeight: '1.7', textAlign: 'justify' }}>
          ...
          <span style={{ fontWeight: 'bold' }}> participated</span> in the <span style={{ fontWeight: 'bold' }}>Sindhanai Sirpi Hackathon</span> conducted by <span style={{ fontWeight: 'bold' }}>EDII and VOSA TECH</span> during the academic year 2025–2026.
          <br /><br />
          The student has exhibited remarkable <span style={{ fontStyle: 'italic' }}>innovation, creativity, and enthusiasm</span> throughout the event. We appreciate their active involvement and contribution to making this initiative a grand success.
        </div>
